...
#ifndef ACCELEROMETER_SWIFT_H
#define ACCELEROMETER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Accelerometer",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13Accelerometer11AppDelegate")
...
SWIFT_CLASS("_TtC13Accelerometer18GameViewController")
@interface GameViewController : UIViewController
@property (nonatomic, strong) IBOutlet UIImageView * _Null_unspecified awaImageView;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC13Accelerometer20ResultViewController")
...
SWIFT_CLASS("_TtC13Accelerometer13SceneDelegate")
...
SWIFT_CLASS("_TtC13Accelerometer14ViewController")
@interface ViewController : UIViewController
- (void)viewDidLoad;
- (IBAction)unwindToViewControllerWithSegue:(UIStoryboardSegue * _Nonnull)segue;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
